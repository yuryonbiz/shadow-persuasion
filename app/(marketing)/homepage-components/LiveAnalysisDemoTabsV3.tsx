...
export default function LiveAnalysisDemoTabsV3() {
  ...
  return (
    <section className="bg-[#0F172A] w-full">
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-16">
        ...
        {/* Input */}
        <div className="bg-[#1E293B] border border-slate-600/30 rounded-xl p-5 mb-6">
        ...
        {/* Tabs */}
        <div className="flex gap-1 mb-1 bg-[#1E293B] p-1 rounded-t-xl border border-b-0 border-slate-600/30">
          {tabs.map((tab) => (
            <button
              key={tab}
        ...
        {/* Tab content */}
        <div className="bg-[#1E293B] border border-slate-600/30 rounded-b-xl p-6 md:p-8 min-h-[350px]">
          {activeTab === 'Overview' && (
            <div className="space-y-6">
              {/* Threat Score */}
              <div className="bg-[#0F172A] rounded-xl p-5 border border-yellow-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#0F172A] rounded-xl p-5 border border-[#D4A017]/20">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="w-full h-3 bg-slate-700 rounded-full"><div className="h-full rounded-full bg-[#D4A017]" style={{ width: `${r.powerDynamics.yourPower * 10}%` }} /></div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm mb-1.5">
                      ...
                      <div className="w-full h-3 bg-slate-700 rounded-full"><div className="h-full rounded-full bg-blue-500" style={{ width: `${r.powerDynamics.theirPower * 10}%` }} /></div>
                    </div>
                  </div>
                  <p className="text-sm text-gray-400 mt-4 leading-relaxed">{r.powerDynamics.dynamicsDescription}</p>
                </div>

                <div className="bg-[#0F172A] rounded-xl p-5 border border-blue-500/20">
          ...
          {activeTab === 'Tactics Detected' && (
            <div className="space-y-4">
              ...
              {r.tactics.map((t, i) => (
                <div key={i} className="bg-[#0F172A] rounded-xl p-5 border border-red-500/20 space-y-3">
                  ...
                  <blockquote className="border-l-3 border-[#D4A017] pl-4 py-2 bg-[#1E293B] rounded-r-lg">
          ...
          {activeTab === 'Response Options' && (
            <div className="space-y-4">
              ...
              {r.responseOptions.map((opt, i) => (
                <div key={i} className="bg-[#0F172A] rounded-xl p-5 border border-[#D4A017]/20 space-y-3">
                  <div className="flex items-center justify-between">
