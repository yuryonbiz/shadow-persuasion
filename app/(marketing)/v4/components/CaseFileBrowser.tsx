      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {caseFiles.map((caseFile, index) => (
            <motion.div
              key={caseFile.id}
              className="bg-gray-800 border-2 border-gray-600 overflow-hidden"
            ...
            >
              ...
              <button
                ...
                className="w-full p-6 text-left hover:bg-gray-750 transition-colors focus:outline-none"
              >
                  ...
                  >
                    <div className="p-6 grid md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-gray-900 p-4 border-l-4 border-amber-500">
