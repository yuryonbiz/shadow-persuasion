      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="hidden lg:block">
          ...
          <div className="space-y-2">
            {conversations.map((conv, index) => (
              <motion.div
                key={index}
                className="grid grid-cols-[2fr_3fr_3fr_1fr] gap-6 bg-[#F4ECD8] border-2 border-gray-400 p-4 hover:bg-[#EDE3D0] transition-colors"
        ...
        <div className="lg:hidden space-y-6">
          {conversations.map((conv, index) => (
            <motion.div
              key={index}
              className="bg-[#F4ECD8] border-2 border-gray-400 p-6 space-y-4"
        ...
        {/* File Footer */}
        <motion.div 
          className="text-center mt-8 p-4 bg-[#EDE3D0] border-2 border-gray-400"
          initial={{ opacity: 0 }}
